      ...
      <table className="w-full min-w-[560px] text-[11px] border-collapse">
        <thead>
          <tr className="border-b border-border sticky top-0 bg-nord-1/50">
            <th className="sticky left-0 bg-nord-1/50 z-10 text-left px-2 py-2 font-semibold text-foreground">Agent</th>
            ...
            <th className="text-right px-2 py-2 font-semibold text-foreground">Avg $</th>
        ...
        <tbody>
          {data.map((row) => (
            <tr key={row.agent} className="border-b border-border/50 hover:bg-primary/5">
              <td className="sticky left-0 bg-nord-1 z-10 px-2 py-2">
                <span
                  style={{
